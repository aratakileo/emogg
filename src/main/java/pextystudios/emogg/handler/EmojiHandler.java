...
public class EmojiHandler {
    ...
    private void load(ResourceManager resourceManager) {
        ...
        if (builtinEmojis.isEmpty()) {
            ...
            emoji = Emoji.from(new ResourceLocation(Emogg.NAMESPACE,"emoji/blob-skeleton-dance.gif"));
            ...
            builtinEmojis.put(emoji.getName(), emoji);
            emoji = Emoji.from(new ResourceLocation(Emogg.NAMESPACE,"emoji/im-okay.png"));
            builtinEmojis.put(emoji.getName(), emoji);
            ...
            builtinEmojis.put(emoji.getName(), emoji);
            emoji = Emoji.from(new ResourceLocation(Emogg.NAMESPACE,"emoji/turn-into-clown.gif"));
            builtinEmojis.put(emoji.getName(), emoji);
